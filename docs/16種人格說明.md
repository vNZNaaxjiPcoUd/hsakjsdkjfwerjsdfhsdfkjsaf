...
以下是 **完整中文版 DISC 個性分析問卷**（共 **24 題**，約 5-8 分鐘完成）。  
這是基於經典 DISC 理論設計的 **免費自評版**，無需註冊，即填即得結果。
...
| 主要類型 | 特質總結 | 職場優勢 | 潛在挑戰 | 溝通建議 |
|----------|----------|----------|----------|----------|
| **D 主導型** | 果斷、目標導向、喜歡掌控 | 領導力強、決策快 | 可能顯得強勢、忽略細節 | 多傾聽，用數據說服 |
| **I 影響型** | 熱情、善於溝通、激勵他人 | 人脈廣、說服力強 | 可能忽視細節、情緒化 | 給具體行動方案 |
| **S 穩健型** | 耐心、合作、重視和諧 | 可靠、團隊黏著劑 | 抗拒改變、決策慢 | 給時間思考，強調穩定 |
| **C 謹慎型** | 精確、分析、注重品質 | 錯誤率低、專業 | 過度追求完美、批評多 | 提供數據與邏輯支持 |
...
完成後若想讓我幫你 **解讀結果** 或 **應用在職場/感情/團隊**，  
請直接回覆你的 **四個數字（D/I/S/C 各幾分）**，我立刻給你客製化分析！
