...
ffmpeg -i 睡前引導uR-FDCxQN10.mp4 -codec:a libmp3lame 睡前引導uR-FDCxQN10.mp3


----

ffmpeg -i IMG_6505.mov -vf scale=640:360 -c:v hevc_videotoolbox -b:v 500k -r 24 -c:a aac -b:a 96k wave.mp4

ffmpeg -hwaccel videotoolbox -i input.mp4 -c:v h264_videotoolbox -threads 0 output.mp4

ffmpeg -hwaccel videotoolbox -i Sp.mp4 -i SP.m4a -c:v h264_videotoolbox -b:v 800k -c:a aac -shortest -vf "format=yuv420p" -threads 0 SpOut.mp4

ffmpeg -i Sp.mp4 -i SP.m4a -c:v copy -c:a copy -shortest -threads 0 SpOut3.mp4
