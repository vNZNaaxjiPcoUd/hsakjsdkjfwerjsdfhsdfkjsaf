...
Here is lock markdow content demo. When unlock state, it will show a temp page. key in your password to see real content. 

[reference](https://c73.jwint.net/keyInfo/hide%20use.md)
